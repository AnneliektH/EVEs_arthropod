...
samtools view -F 4 -b '/media/falklabuser/LargeData/Anneliek/new_EVEs_both/species/'$1'/bam_files/'$1'.bam' > '/media/falklabuser/LargeData/Anneliek/new_EVEs_both/species/'$1'/bam_files/'$1'_mapped.bam'

# Use the new bed file to filter the bam file Anneliek made
samtools view -L '/media/falklabuser/LargeData/Anneliek/new_EVEs_both/species/'$1'/in_clusters/bed_files/'$1'.bed' -b '/media/falklabuser/LargeData/Anneliek/new_EVEs_both/species/'$1'/bam_files/'$1'_mapped.bam' > '/media/falklabuser/LargeData/Anneliek/new_EVEs_both/species/'$1'/in_clusters/'$1'_all_EVEs.bam'
...
# Use the new bed file to filter the bam file Anneliek made
samtools view -L '/media/falklabuser/LargeData/Anneliek/new_EVEs_both/species/'$1'/out_clusters/bed_files/'$1'.bed' -b '/media/falklabuser/LargeData/Anneliek/new_EVEs_both/species/'$1'/bam_files/'$1'_mapped.bam' > '/media/falklabuser/LargeData/Anneliek/new_EVEs_both/species/'$1'/out_clusters/'$1'_all_EVEs.bam'
...
for b in *.bed; do samtools view -L $b -b '/media/falklabuser/LargeData/Anneliek/new_EVEs_both/species/'$1'/bam_files/'$1'_mapped.bam' >'/media/falklabuser/LargeData/Anneliek/new_EVEs_both/species/'$1'/out_clusters/individual_EVE_bam_files/'${b%%.*}'.bam'; done
...
for b in *.bed; do samtools view -L $b -b '/media/falklabuser/LargeData/Anneliek/new_EVEs_both/species/'$1'/bam_files/'$1'_mapped.bam' >'/media/falklabuser/LargeData/Anneliek/new_EVEs_both/species/'$1'/in_clusters/individual_EVE_bam_files/'${b%%.*}'.bam'; done
