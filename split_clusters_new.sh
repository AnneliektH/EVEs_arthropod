...
python '/media/falklabuser/LargeData/Anneliek/new_EVEs_both/Scripts/remove_picluster_mod2.py' ''$1'_manual.csv' '/media/falklabuser/LargeData/Anneliek/new_EVEs_both/new_cluster_files/'$1'.csv' './out_clusters/'$1'_df3.csv' './out_clusters/'$1'_df4.csv' './out_clusters/'$1'_df5.csv' './in_clusters/'$1'.csv'
